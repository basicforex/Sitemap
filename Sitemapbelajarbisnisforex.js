...
function displayToc2() {
   ...
   document['write']('</div><div style="text-align:right;margin-right:7px;"><a title="Sitemap" style="font:bold 8px Arial,Sans-Serif;color:#666 !important;text-shadow:0px 1px 0px rgba(255,255,255,0.1);opacity:1 !important;visibility:visible !important;display:block !important;" href="http://www.belajarbisnisforex.com" target="_blank">&#9658; Belajar Bisnis Forex</a></div>');
};
$(function () {
   if (accToc) {
